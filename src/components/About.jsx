  ...
  return (
    <div className='flex flex-col items-center justify-center container mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden' id='About'>
      ...
      <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20'>
        <img src={assets.project} alt="brand_img" className='w-auto h-[420px] rounded sm:w-1/2 max-w-lg' />
        <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
            ...
            <p className='my-3 max-w-lg'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rerum voluptatum cum veniam cumque sapiente, numquam et laborum.</p>

...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "73f78e7b-090e-4651-bbe4-ad9088a29fbd");
  ...
  return (
    <div className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='Contact'>
      ...
      <form onSubmit={onSubmit} action="" className='max-w-2xl mx-auto text-black pt-8'>
        ...
        <div className='my-6 text-left'>
            Message
            <textarea className='w-full border border-gray-300 rounded py-3 px-4 mt-2 h-40 resize-none' name="Message" placeholder='Message' required></textarea>
        </div>

    ...
    <div className='absolute fixe top-0 left-0 w-full z-10'>
        <div className='container mx-auto flex justify-between items-center py-1 px-8 md:px-25 lg:px-32 bg-transparent'>
            ...
            <ul className='hidden md:flex gap-7 text-white font-semibold text-lg'>
                ...
                <a href='#Projects' className='cursor-pointer hover:text-black'>Projects</a>
                <a href='#Testimonials' className='cursor-pointer hover:text-black'>Testimonials</a>
            </ul>
            <button className='hidden md:block bg-blue-500 font-semibold text-white px-8 mb-4 py-2 rounded-full hover:text-black'>Sign Up</button>
